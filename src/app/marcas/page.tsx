...
const todasLasMarcas = [
  // Marcas de calderas
  { name: "Vaillant", slug: "vaillant", logo: "/images/marcas/vaillant.webp", tipo: "calderas" },
  { name: "Junkers", slug: "junkers", logo: "/images/marcas/junkers.webp", tipo: "calderas" },
  { name: "Baxi", slug: "baxi", logo: "/images/marcas/baxi.webp", tipo: "calderas" },
  { name: "Ferroli", slug: "ferroli", logo: "/images/marcas/ferroli.webp", tipo: "calderas" },
  { name: "Ariston", slug: "ariston", logo: "/images/marcas/ariston.webp", tipo: "calderas" },
  { name: "Viessmann", slug: "viessmann", logo: "/images/marcas/viessmann.webp", tipo: "calderas" },
  { name: "Beretta", slug: "beretta", logo: "/images/marcas/beretta.webp", tipo: "calderas" },
  { name: "Chaffoteaux", slug: "chaffoteaux", logo: "/images/marcas/chaffoteaux.webp", tipo: "calderas" },
  { name: "Cointra", slug: "cointra", logo: "/images/marcas/cointra.webp", tipo: "calderas" },
  { name: "Bosch", slug: "bosch", logo: "/images/marcas/bosch.webp", tipo: "calderas" },
  { name: "Wolf", slug: "wolf", logo: "/images/marcas/wolf.webp", tipo: "calderas" },
  { name: "Baxi Roca", slug: "baxi-roca", logo: "/images/marcas/baxi-roca.webp", tipo: "calderas" },
  { name: "Saunier Duval", slug: "saunier-duval", logo: "/images/marcas/saunier-duval.webp", tipo: "calderas" },
  { name: "Immergas", slug: "immergas", logo: "/images/marcas/immergas.webp", tipo: "calderas" },
  { name: "Hermann", slug: "hermann", logo: "/images/marcas/hermann.webp", tipo: "calderas" },
  { name: "Biasi", slug: "biasi", logo: "/images/marcas/biasi.webp", tipo: "calderas" },
  { name: "Domusa", slug: "domusa", logo: "/images/marcas/domusa.webp", tipo: "calderas" },
  { name: "Fagor", slug: "fagor", logo: "/images/marcas/fagor.webp", tipo: "calderas" },
  { name: "Manaut", slug: "manaut", logo: "/images/marcas/manaut.webp", tipo: "calderas" },
  { name: "Tifell", slug: "tifell", logo: "/images/marcas/tifell.webp", tipo: "calderas" },
  { name: "Neckar", slug: "neckar", logo: "/images/marcas/neckar.webp", tipo: "calderas" },
  { name: "Lamborghini", slug: "lamborghini", logo: "/images/marcas/lamborghini.webp", tipo: "calderas" },
  { name: "Sime", slug: "sime", logo: "/images/marcas/sime.webp", tipo: "calderas" },
  { name: "De Longhi", slug: "delonghi", logo: "/images/marcas/delonghi.webp", tipo: "calderas" },
  { name: "Intergas", slug: "intergas", logo: "/images/marcas/intergas.webp", tipo: "calderas" },
  
  // Marcas de aire acondicionado
  { name: "Daikin", slug: "daikin", logo: "/images/marcas/daikin.webp", tipo: "aire" },
  { name: "Mitsubishi", slug: "mitsubishi", logo: "/images/marcas/mitsubishi.webp", tipo: "aire" },
  { name: "Fujitsu", slug: "fujitsu", logo: "/images/marcas/fujitsu.webp", tipo: "aire" },
  { name: "LG", slug: "lg", logo: "/images/marcas/lg.webp", tipo: "aire" },
  { name: "Samsung", slug: "samsung", logo: "/images/marcas/samsung.webp", tipo: "aire" },
  { name: "Toshiba", slug: "toshiba", logo: "/images/marcas/toshiba.webp", tipo: "aire" },
  { name: "Carrier", slug: "carrier", logo: "/images/marcas/carrier.webp", tipo: "aire" },
  { name: "Panasonic", slug: "panasonic", logo: "/images/marcas/panasonic.webp", tipo: "aire" },
  { name: "Hisense", slug: "hisense", logo: "/images/marcas/hisense.webp", tipo: "aire" },
  { name: "Haier", slug: "haier", logo: "/images/marcas/haier.webp", tipo: "aire" },
  { name: "Midea", slug: "midea", logo: "/images/marcas/midea.webp", tipo: "aire" },
  { name: "Daitsu", slug: "daitsu", logo: "/images/marcas/daitsu.webp", tipo: "aire" },
  { name: "Airwell", slug: "airwell", logo: "/images/marcas/airwell.webp", tipo: "aire" },
];
