...
function ProductCard({ product, onAddToCart }: { 
  ...
  return (
    <Link 
      href={`/tienda/repuestos/calderas/${product.brandSlug}/${product.familySlug}/${product.slug}`}
...
export default function RepuestosFamiliaMarca() {
  ...
  const jsonLd = {
    ...
    "url": `https://uniclima.es/tienda/repuestos/calderas/${marca}/${familia}`,
    "breadcrumb": {
      "@type": "BreadcrumbList",
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 5, "name": familiaInfo.name, "item": `https://uniclima.es/tienda/repuestos/calderas/${marca}/${familia}` }
      ]
    }
  };
        ...
        <section className="bg-gradient-to-br from-orange-500 via-orange-600 to-red-600 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <nav className="flex items-center gap-2 text-orange-100 text-sm mb-4 flex-wrap">
              ...
              <ChevronRight className="w-4 h-4" />
              <Link href={`/tienda/repuestos/calderas/${marca}`} className="hover:text-white transition-colors">{marcaInfo.name}</Link>
              <ChevronRight className="w-4 h-4" />
