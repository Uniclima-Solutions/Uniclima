...
export default function ProductoPage() {
  ...
  const productJsonLd = {
    ...
    "isRelatedTo": relacionados.map(r => ({
      "@type": "Product",
      "name": r.name,
      "url": `/repuestos/calderas/${marca}/${familia}/${r.slug}`
    }))
  };
  ...
  const breadcrumbJsonLd = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 4, "name": producto.brand, "item": `https://uniclima.es/repuestos/calderas/${marca}` },
      { "@type": "ListItem", "position": 5, "name": producto.family, "item": `https://uniclima.es/repuestos/calderas/${marca}/${familia}` },
      { "@type": "ListItem", "position": 6, "name": producto.reference, "item": `https://uniclima.es/repuestos/calderas/${marca}/${familia}/${productoSlug}` }
    ]
  };
        ...
        <div className="bg-white border-b border-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
            <nav className="flex items-center gap-2 text-gray-500 text-sm flex-wrap">
              ...
              <Link href="/repuestos" className="hover:text-orange-600 transition-colors">Repuestos</Link>
              <ChevronRight className="w-4 h-4" />
              <Link href="/repuestos/calderas" className="hover:text-orange-600 transition-colors">Calderas</Link>
              <ChevronRight className="w-4 h-4" />
              <Link href={`/repuestos/calderas/${marca}`} className="hover:text-orange-600 transition-colors">{producto.brand}</Link>
              <ChevronRight className="w-4 h-4" />
              <Link href={`/repuestos/calderas/${marca}/${familia}`} className="hover:text-orange-600 transition-colors">{producto.family}</Link>
              <ChevronRight className="w-4 h-4" />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {relacionados.map((rel) => (
                <Link
                  key={rel.id}
                  href={`/repuestos/calderas/${marca}/${familia}/${rel.slug}`}
