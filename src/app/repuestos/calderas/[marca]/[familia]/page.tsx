...
const familiasData: Record<string, { name: string; description: string }> = {
  "placas-electronicas": { name: "Placas Electrónicas", description: "Placas de control y gestión para calderas" },
...
function ProductCard({ product, onAddToCart }: { 
  ...
  return (
    <Link 
      href={`/repuestos/calderas/${product.brandSlug}/${product.familySlug}/${product.slug}`}
...
export default function RepuestosFamiliaMarca() {
  ...
  const jsonLd = {
    ...
    "description": `${familiaInfo.description} para calderas ${marcaInfo.name}`,
    "url": `https://uniclima.es/repuestos/calderas/${marca}/${familia}`,
    "breadcrumb": {
      "@type": "BreadcrumbList",
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 4, "name": marcaInfo.name, "item": `https://uniclima.es/repuestos/calderas/${marca}` },
        { "@type": "ListItem", "position": 5, "name": familiaInfo.name, "item": `https://uniclima.es/repuestos/calderas/${marca}/${familia}` }
      ]
    }
  };
      ...
      <main className="pt-20 lg:pt-28 bg-gray-50 min-h-screen">
        ...
        <section className="bg-gradient-to-br from-orange-500 via-orange-600 to-red-600 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            {/* Breadcrumbs */}
            <nav className="flex items-center gap-2 text-orange-100 text-sm mb-4 flex-wrap">
              ...
              <ChevronRight className="w-4 h-4" />
              <Link href="/repuestos/calderas" className="hover:text-white transition-colors">Calderas</Link>
              <ChevronRight className="w-4 h-4" />
              <Link href={`/repuestos/calderas/${marca}`} className="hover:text-white transition-colors">{marcaInfo.name}</Link>
              <ChevronRight className="w-4 h-4" />
              ...
              <div className="w-full lg:w-80">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3 rounded-xl bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-300 shadow-lg"
                  />
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <select
                    ...
                    className="text-sm border-gray-200 rounded-lg focus:ring-orange-500 focus:border-orange-500"
                  >
