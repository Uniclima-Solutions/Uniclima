...
const planesAire = [
  {
    ...
    detalles: [
      "Intervención programada entre marzo y abril",
  ...
  },
  {
    ...
    detalles: [
      "1ª intervención preventiva (mar-abr)",
      "2ª intervención de verificación (invierno)",
      "Máxima prioridad en reparaciones urgentes",
      "Repuestos originales con descuento máximo",
      "Garantía extendida en reparaciones",
    ],
...
export default function Home() {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
          <Link href="/ofertas" className="block">
            <img 
              ...
              className="w-full h-auto object-contain mx-auto drop-shadow-xl hover:scale-[1.02] transition-transform duration-300"
      ...
      <section className="w-full bg-gradient-to-r from-gray-50 to-gray-100 my-6 sm:my-8 lg:my-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
