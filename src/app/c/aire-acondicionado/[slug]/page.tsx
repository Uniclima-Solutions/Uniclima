...
/**
 * Página de Subcategoría: Tipo de Repuesto de Aire Acondicionado
...
const categoryNames: Record<string, string> = {
  'placas-interior': 'Placas Interior',
  'placas-compresor': 'Placas Compresor',
  'turbinas': 'Turbinas',
  'motor-turbinas': 'Motor Turbinas',
  'helice-compresor': 'Hélice Compresor',
  'motor-helice-compresor': 'Motor Hélice Compresor',
  'bomba-condensado-conductos': 'Bomba Condensado Conductos',
  'bomba-condensados-cassette': 'Bomba Condensados Cassette',
  'mandos-distancia': 'Mandos a Distancia'
};
...
const generateProducts = (category: string, count: number = 36) => {
  ...
  return Array.from({ length: count }, (_, i) => {
    ...
    return {
      id: `aire-${category}-${i + 1}`,
      name: `${categoryName} ${marcas[i % marcas.length].name} - Modelo ${2000 + i}`,
      reference: `REF-${category.toUpperCase().slice(0, 3)}-${20000 + i}`,
    ...
    <Link href={`/producto/${product.id}`} className="group">
      <div className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300">
        ...
        <div className="p-3">
          ...
          <h3 className="text-sm font-medium text-gray-900 line-clamp-2 group-hover:text-blue-600 transition-colors min-h-[40px]">
            {product.name}
          </h3>
...
export default function CategoriaAireAcondicionadoPage() {
  ...
  const allProducts = useMemo(() => generateProducts(slug, 36), [slug]);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="pt-4 pb-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <nav className="flex items-center gap-2 text-sm mb-4">
            ...
            <Link href="/c/aire-acondicionado" className="text-gray-500 hover:text-blue-600">
          ...
          <div className="mb-6">
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">
              {categoryName} para Aire Acondicionado
            </h1>
            <p className="text-gray-600 mt-2">
              Encuentra {categoryName.toLowerCase()} originales y compatibles para equipos de aire acondicionado de todas las marcas. 
      ...
      <CollectionSchema
        collection={{
          name: `${categoryName} para Aire Acondicionado`,
          description: `Encuentra ${categoryName.toLowerCase()} originales y compatibles para equipos de aire acondicionado de todas las marcas.`,
          url: `/c/aire-acondicionado/${slug}`,
