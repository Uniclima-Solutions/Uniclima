...
export const products: Product[] = [
  {
    ...
    images: [
      ...
      { id: "1-3", url: "/images/category-placas.jpg", alt: "Válvula de Gas Honeywell VK4105M - Conexiones", isPrimary: false },
      { id: "1-4", url: "/images/hero-calderas.jpg", alt: "Válvula de Gas Honeywell VK4105M - Instalada", isPrimary: false },
    ],
    inStock: true,
    stockQuantity: 15,
...
- Cumple con todas las normativas europeas de seguridad`,
  ...
  },
  {
    ...
    images: [
      ...
      { id: "2-3", url: "/images/category-placas.jpg", alt: "Intercambiador de Placas 14P - Conexiones", isPrimary: false },
    ],
    inStock: true,
    stockQuantity: 8,
