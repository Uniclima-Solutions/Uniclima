...
const ContratoAireAcondicionado = forwardRef<HTMLDivElement, ContratoAireAcondicionadoProps>(
  ({ datosCliente, datosContrato, firmaCliente, mostrarFirmaEmpresa = false }, ref) => {
    ...
    const getPlanDescription = () => {
      switch (datosContrato.plan) {
        case 'Esencial':
          return 'una (1) revisión anual del equipo de aire acondicionado';
        case 'Confort':
          return 'dos (2) revisiones anuales del equipo (una en primavera y otra en otoño)';
        case 'Premium':
          return 'revisiones ilimitadas del equipo durante todo el año, con prioridad en la atención';
        default:
          return 'una (1) revisión anual del equipo de aire acondicionado';
      }
    };
...
ContratoAireAcondicionado.displayName = 'ContratoAireAcondicionado';

export default ContratoAireAcondicionado;
