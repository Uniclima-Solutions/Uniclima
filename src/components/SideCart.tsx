...
export default function SideCart() {
  ...
  return (
    <>
      ...
      {/* Side Cart Panel - MÁS GRANDE */}
      <div
        className={`fixed right-0 top-0 bottom-0 w-full sm:w-[420px] max-w-[100vw] bg-white shadow-2xl z-50 flex flex-col transition-transform duration-300 ease-out overflow-hidden ${
